<template>
  <el-container id="app">
    <el-header style="background-color: #409eff; color: white; display: flex; justify-content: space-between; align-items: center;">
      ...
      <div>
        <el-button style="color: white;" size="large" type="text">注销</el-button>
      </div>
    </el-header>
    <el-container>
      <el-aside>
       <el-menu background-color="#545c64" text-color="#fff" style="height: 100%;" router :default-active="$route.path">
